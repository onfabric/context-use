...
from contextuse.config import parse_config
from contextuse.core.etl import ETLPipeline, UploadStrategy
...
from contextuse.providers.registry import (
    PROVIDER_REGISTRY,
    Provider,
    get_provider_config,
)
...
class ContextUse:
    """Main entry point for the contextuse library.
            ...
            for desc in task_descriptors:
                ...
                try:
                    ...
                    self._update_etl_task_status(
                        etl_task_id, EtlTaskStatus.EXTRACTING
                    )
                    ...
                    self._update_etl_task_status(
                        etl_task_id, EtlTaskStatus.UPLOADING
                    )
                    ...
                    self._update_etl_task_status(
                        etl_task_id, EtlTaskStatus.FAILED
                    )
