...
from contextuse.providers.chatgpt.schemas import ChatGPTMessage
...
def _safe_timestamp(ts: float | int | None) -> Optional[datetime]:
    ...
    def transform(
        ...
        for df in batches:
            ...
            for _, record in df.iterrows():
                ...
                asat = _safe_timestamp(create_time) or datetime.now(timezone.utc)
