...
from tests.conftest import (
    INSTAGRAM_LIKED_POSTS_JSON,
    INSTAGRAM_STORY_LIKES_JSON,
)
...
class TestInstagramLikedPostsPipe(PipeTestKit):
    ...
    def pipe_fixture(self, tmp_path: Path):
        ...
        storage.write(key, json.dumps(INSTAGRAM_LIKED_POSTS_JSON).encode())
        return storage, key
...
class TestInstagramStoryLikesPipe(PipeTestKit):
    ...
    def pipe_fixture(self, tmp_path: Path):
        ...
        storage.write(key, json.dumps(INSTAGRAM_STORY_LIKES_JSON).encode())
        return storage, key
