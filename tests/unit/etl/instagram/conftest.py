...
_V0 = f"{_BASE}/v0/threads"
_V1 = f"{_BASE}/v1/threads"

INSTAGRAM_STORIES_JSON: dict = load_fixture(
    f"{_V1}/your_instagram_activity/media/stories.json"
)
INSTAGRAM_REELS_JSON: dict = load_fixture(
    f"{_V1}/your_instagram_activity/media/reels.json"
)
INSTAGRAM_POSTS_JSON: list[dict] = load_fixture(
    f"{_V1}/your_instagram_activity/media/posts_1.json"
)

INSTAGRAM_VIDEOS_WATCHED_V0_JSON: dict = load_fixture(
    f"{_V0}/ads_information/ads_and_topics/videos_watched.json"
)
INSTAGRAM_VIDEOS_WATCHED_V1_JSON: list[dict] = load_fixture(
    f"{_V1}/ads_information/ads_and_topics/videos_watched.json"
)

INSTAGRAM_POSTS_VIEWED_V0_JSON: dict = load_fixture(
    f"{_V0}/ads_information/ads_and_topics/posts_viewed.json"
)
INSTAGRAM_POSTS_VIEWED_V1_JSON: list[dict] = load_fixture(
    f"{_V1}/ads_information/ads_and_topics/posts_viewed.json"
)

INSTAGRAM_PROFILE_SEARCHES_JSON: dict = load_fixture(
    f"{_V1}/logged_information/recent_searches/profile_searches.json"
)

INSTAGRAM_LIKED_POSTS_V0_JSON: dict = load_fixture(
    f"{_V0}/your_instagram_activity/likes/liked_posts.json"
)
INSTAGRAM_LIKED_POSTS_V1_JSON: list[dict] = load_fixture(
    f"{_V1}/your_instagram_activity/likes/liked_posts.json"
)
...
INSTAGRAM_REELS_COMMENTS_JSON: dict = load_fixture(
    f"{_V1}/your_instagram_activity/comments/reels_comments.json"
)

INSTAGRAM_FOLLOWERS_JSON: list[dict] = load_fixture(
    f"{_V1}/connections/followers_and_following/followers_1.json"
)
...
INSTAGRAM_SAVED_COLLECTIONS_JSON: dict = load_fixture(
    f"{_V1}/your_instagram_activity/saved/saved_collections.json"
)

INSTAGRAM_DM_INBOX_JSON: dict = load_fixture(
    f"{_V1}/your_instagram_activity/messages/inbox/bobsmith_1234567890/message_1.json"
)
